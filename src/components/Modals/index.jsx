    ...
    return (
        <Transition.Root show={open} as={Fragment} onClose={onClose}>
            <Dialog as="div" className="relative z-10">
                ...
                <div className="fixed inset-0 z-10 overflow-y-auto py-14">
                    <div className="flex min-h-full items-end justify-center px-5 py-4 text-center md:items-center md:p-0">
                        ...
                        >
                            <Dialog.Panel className={clsx("modal relative transform overflow-hidden rounded-2xl text-left shadow-xl transition-all max-w-6xl", className)}>
                                {children}
                            </Dialog.Panel>
                        </Transition.Child>
                    </div>
